...
class CommunicationController extends AdminController
{
    ...
    public function emailingListeContactExportAction($id)
    {
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getFont()->applyFromArray(array(
            'bold' => true, 'size' => 12, 'name' => 'Arial', 'color' => array('rgb' => '404040')));
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1:B1')->getFont()->applyFromArray(array(
            'bold' => true, 'size' => 12, 'name' => 'Arial', 'color' => array('rgb' => '404040')));
        $objPHPExcel->getActiveSheet()->SetCellValue('A1', $listInfos[0]['Name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('B1',
            $listInfos[0]['SubscriberCount'].' contacts');
            ...
            if (isset($UsersListes[0])) {
                ...
                if ($Roles[0] != 'ROLE_ADMIN' || $Roles[0] != 'ROLE_SUPERADMIN') {
                    ...
                    $objPHPExcel->getActiveSheet()->SetCellValue('A'.$i,
                        $UsersListes[0]->getFirstname());
                    $objPHPExcel->getActiveSheet()->SetCellValue('B'.$i,
                        $UsersListes[0]->getName());
                    $objPHPExcel->getActiveSheet()->SetCellValue('C'.$i,
                        $UsersListes[0]->getEmail());
                    ...
                    if ($contacts['IsUnsubscribed'] == '1') {
                        $objPHPExcel->getActiveSheet()->getStyle('A'.$i.':E'.$i.'')->getFont()->applyFromArray(array(
                            'italic' => true, 'color' => array('rgb' => 'a8a8a8')));
